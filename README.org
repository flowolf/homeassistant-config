...
[[https://git.flo.cx/flowolf/homeassistant-config/commits/master][https://git.flo.cx/flowolf/homeassistant-config/badges/master/pipeline.svg]]
...
- IP webcam running MotionEyeOS and a RaspberryPi Zero W with Zero Cam.
